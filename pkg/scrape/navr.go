...
func NaughtyAmericaVR(wg *sync.WaitGroup, updateSite bool, knownScenes []string, out chan<- models.ScrapedScene) error {
	...
	sceneCollector.OnHTML(`html`, func(e *colly.HTMLElement) {
		...
		e.ForEach(`dl8-video`, func(id int, e *colly.HTMLElement) {
			...
			filenames := []string{"_180x180_3dh.mp4", "_smartphonevr60.mp4", "_smartphonevr30.mp4", "_vrdesktopsd.mp4", "_vrdesktophd.mp4", "_180_sbs.mp4", "_180x180_3dh.mp4", "_6kvr264.mp4", "_6kvr265.mp4"}
